...
Acesse a pasta clonada ou baixada pelo terminal e depois execute
...
- Argumentos com aspas devem usar as aspas obrigatoriamente e o interior é um nome qualquer;
- `tipo` deve ser apenas `T` para trajetos ou veículos terrestres e `A` para aquáticos;
...
- __Cadastro de Transporte__ : Use `cadastrar_transporte "nome_transporte" tipo capacidade_passageiros velocidade distancia_entre_descanços horas_de_descanço "nome_cidade_local"` para cadastrar um transporte os dados parametros definidos;
